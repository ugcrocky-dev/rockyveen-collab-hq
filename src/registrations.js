...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-15 ~20:51 poll-collab-otp-tight: still locked — 0 unlock/reset/Verification after:2026/09/07. Newest Impact mail still Hill House Home newsletter @19:38 + NH Hotels @18:35 + Munchkin/Govee/CorelDRAW (all brand noise — NOT unlock) + Daily Digest @07:06 (NOT unlock) + Updates Digest @14:18 Sep 14 (NOT unlock). SHEIN promo ≠ unlock. Newest Verification still 165312 @09:26 Sep 6 expired. Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
