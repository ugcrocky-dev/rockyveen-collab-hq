...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~06:35 poll-statusphere-rakuten: SKIP login — Keycloak Invalid since ~03:38 (do not hammer). Gmail after:2026/09/07: only ExitLag DENIED @21:30 + Tresorit Partnered @12:05; 0 newer Partnered/Denied after:2026/09/08. Still 3 Partnered (Blockchain Council + Wondershare + Tresorit) + ~10 Pending (Keeper, Skylum, Brytesoft, NordVPN(+APAC), PureVPN, ESET, HTVRONT, Webroot Inc, IONOS). SID 4747686.',
    jobs: [
      {
