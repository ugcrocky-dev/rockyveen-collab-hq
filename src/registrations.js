...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~04:21 impact-unlock-retry: Gmail still NO fresh unlock/reset (newest Impact still Verification 165312 @09:26 Sep 6 + AM resets only; 0 Impact mail in last 12h). Did NOT login. 0 programs. Fresh unlock required — no hammer. Rescheduled once more.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~03:45 poll-apply-tasks (task df46fb1f): Network still Pending (\"Your Network Profile is being reviewed\"); profile 69%. Home banner: \"Your 2 program applications are on hold\" — Reclaim.ai + ElevenLabs on hold until Network accepted. Descript Application pending review. Did NOT re-submit/mass-apply. No PartnerStack approval mail. Skip phone/tax/card/IG. FlexOffers phone-gated; Digistore skip (~03:38 no-advance); Refersion blocked; Impact no unlock.',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
        ...
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — reconfirmed 2026-09-07 ~03:45 (do not re-submit).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-07 ~03:45 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — reconfirmed 2026-09-07 ~03:45 (do not re-submit). Banner: on hold until accepted into PartnerStack Network.',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-07 ~03:45 (profile 69%). Do not re-submit.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~03:38 poll-collab-otp-tight: skipped — Company Information still requires Mobile Phone (do not invent). No new unlock mail (old verify threads only). 0 offers. User must enter phone + Continue.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~03:38 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Adspaces still Not reviewed. Leave pending until Active/manual password clear.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~03:38 poll-collab-otp-tight: ONE calm login attempt (task 434af1c8) — page had no LOGCAP/captcha but login did NOT advance to dashboard; STOPPED (no further hammer). Username rockyveenaffiliate. ~10 products already joined. Manual resolve before AI/SaaS joins.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~03:38 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; no fresh useful OTP (old temp codes only). Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
