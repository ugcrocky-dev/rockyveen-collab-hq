...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-26 ~16:41 poll-collab-otp-tight: still locked — 0 unlock/reset/Verification after:2026/09/07 (inbox+spam). Newest Verification still 165312 @09:26 Sep 6 expired. Newest Impact mail: Farberware MOCHA bakeware promo @23:45 Sep 25 ≠ unlock (1a0daf5caff9a498); Farberware September 2026 Promotions @23:02 Sep 25 ≠ unlock (1a0daceaa9841716); Anolon September 2026 Promotions @22:43 Sep 25 ≠ unlock (1a0dabc9300cf0a0); CorelDRAW Web upgrade promo @18:40 Sep 25 ≠ unlock (1a0d9decef0790bf). Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'DECLINED/limited 2026-09-08 ~19:00 — reason: One of your links is not working. Gmail ~10:25 Sep 9: no newer PartnerStack mail; last browser ~22:02 still Declined / reapply Sep 22. Did not reapply this poll.',
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        id: 'prog-runway',
        brand: 'Runway',
        title: 'Runway Affiliates',
        status: 'won',
        appliedAt: '2026-09-04',
        rate: 'Affiliate — code rocky25 (25% off / $15 per paid plan)',
        notes: 'WON via Gmail 2026-09-18 ~18:09 — Welcome to Runway Affiliates (affiliates@runwayml.com). Affiliate code rocky25 LIVE (25% off any plan; $15/paid signup). Personal Max upgrade coupon FEC5142FDD4F36CF (3 mo free Max monthly / $285 off yearly at runwayml.com). Final step: set up payouts at https://affiliates.runwayml.com/ (same email as Runway account) — do not invent banking. Account collabs@rockyveen.com; contract signed.',
        href: 'https://affiliates.runwayml.com/',
      },
      {
        id: 'prog-luma',
        brand: 'Luma AI',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-26 ~16:41 poll-collab-otp-tight: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/11. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-26 ~16:41 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — last @10:00 + @09:15 Sep 9; 0 newer through ~16:41 Sep 26. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      '2026-09-09 ~18:09 poll-statusphere-rakuten: Gmail (inbox+spam) — no NEW verify/unlock after:2026/09/08. Still only waitlist @12:00 UTC 2026-09-06 + update @08:40. Remain registered_waitlisted. No phone/street invention. Next poll ~20:09 Sep 9.',
    jobs: [],
  },
  {
    id: 'partnerize',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-26 ~16:41 poll-collab-otp-tight: still approved Tapfiliate $178 @12:53 Sep 7 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW Tapfiliate program approvals after:2026/09/11.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-26 ~16:41 poll-collab-otp-tight: SKIP login — prior ~03:38 no-advance (Username rockyveenaffiliate); do not hammer. Newest Digistore mail: Nick newsletter @13:11 Sep 20 (traffic-drop promo — newsletter only; do not login). Prior Nick @22:23 Sep 17 + tips @13:31; Lenée promo @22:17 Sep 14. Manual resolve before AI/SaaS joins. ~10 products already joined.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-26 ~16:41 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/11. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-26 ~16:41 poll-collab-otp-tight: SKIP login — Keycloak Invalid since ~03:38 (do not hammer). Gmail: NEW Partnered Webroot Inc. @20:53 Sep 25 (1a0da586c05cc61a); prior Keeper Security @09:25 Sep 10. Skylum DENIED @07:51 Sep 14 still newest denial. Now 6 Partnered (Blockchain Council + Wondershare + Tresorit + HTVRONT + Keeper Security + Webroot Inc.) + ~5 Pending (Brytesoft, NordVPN(+APAC), PureVPN, ESET, IONOS). ExitLag DENIED @21:30 not Pending.',
    jobs: [
      {
        ...
        appliedAt: '2026-09-07',
        rate: 'Affiliate',
        notes: 'Partnered / Approved via Gmail 2026-09-10 ~09:25 (Keeper Security approved Rocky Veen marketing channel). Was Apply Pending 2026-09-07. MID 54233 / offer 2065364.',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: 'Affiliate',
        notes: 'Partnered / Approved via Gmail 2026-09-25 ~20:53 (Webroot Inc. approved Rocky Veen marketing channel; 1a0da586c05cc61a). Was Apply Pending 2026-09-06. MID 24709.',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: 'Affiliate',
        notes: 'Partnered / Approved via Gmail 2026-09-09 ~07:36 (HTVRONT approved Rocky Veen marketing channel). Was Apply Pending 2026-09-06. MID 44712.',
