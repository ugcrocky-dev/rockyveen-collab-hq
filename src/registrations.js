...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:59 poll-apply-tasks: Browser dash confirmed — Network still Pending; home banner still \"Your 2 program applications are on hold\" (auto-submit after network approval — did NOT re-submit); Descript Application pending; profile still 69%. Do not click Apply on marketplace holds. Gmail: 0 PartnerStack after:2026/09/06; 0 Impact unlock/reset/Verification after:2026/09/07. Skip phone/tax/card/IG. FlexOffers phone-gated; Digistore skip; Refersion blocked.',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
        ...
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — reconfirmed 2026-09-08 ~04:59 (do not re-submit).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-08 ~04:59 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-08 ~04:59 (profile still 69%). Do not re-submit.',
