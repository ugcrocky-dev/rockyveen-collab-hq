...
export const platforms = [
  {
    ...
    notes:
      'Logged in. Photo upload attempted. Wayy.ai already Applied. No other open AI/SaaS campaigns found this pass. Profile social fields appear gated behind IG OAuth (skipped).',
    jobs: [
      {
        id: 'flinque-wayy',
        brand: 'Wayy.ai',
  ...
  },
  {
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Partner account created. Continue joining brand programs.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      'OTP 195987 verified. Profile complete: Rocky Veen, @rockyveen (text), rockyveen.com, photo uploaded, Tech/App niches, $500+ rates. Ready to apply AI/SaaS jobs next pass.',
    jobs: [],
  },
  {
    id: 'soona',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      'Account created with email/password. IG @rockyveen added as text handle only (no OAuth). Full IG connect skipped per email-only rule.',
    jobs: [],
  },
  {
    id: 'framer-dub',
  ...
  },
  {
    ...
    category: 'freelance',
    notes:
      'Live at twine.net/rockyveenugc. Name/bio/NYC set. Automation stuck on role modal (still shows 1st AD) + photo/website fields. Manual 1-min fix: roles → Video/UGC/Content Creator, add rockyveen.com + photo. IG OAuth skipped.',
    jobs: [],
  },
  {
    id: 'shareasale-awin',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      'Email verified via SendGrid link. Descript program application received and under review at dash.partnerstack.com/descriptinc/application. Links/performance locked until approval. No phone/SSN/IG required yet.',
    jobs: [
      {
        id: 'ps-descript',
        brand: 'Descript',
