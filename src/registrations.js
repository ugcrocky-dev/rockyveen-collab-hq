...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:41 poll-collab-otp-tight: still locked — 0 unlock/reset/Verification after:2026/09/07 (inbox+spam). Only brand Ad Code @12:11 Minor Hotels (NOT unlock). Newest Verification still 165312 @09:26 Sep 6 (expired). Did NOT login (no hammer). Prior ~19:12/~16:49 also 0 unlock. CreatorReady/Creator.co skipped.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:41 poll-collab-otp-tight: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/08. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:41 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — @10:00 + @09:15 Sep 9 (+ Sep 8 nags); 0 newer after @10:00. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:41 poll-collab-otp-tight: still approved Tapfiliate $178 @12:53 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW Tapfiliate program approvals after:2026/09/08.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:41 poll-collab-otp-tight: SKIPPED login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. Digistore newsletter only @11:51 (Top 4 Affiliate Metrics) — not actionable. 0 login/OTP Digistore mail after:2026/09/08.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:41 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/08. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:41 poll-collab-otp-tight: SKIP login — Keycloak Invalid since ~03:38 (do not hammer). Gmail: 0 NEW Partnered/Denied among pending SaaS after HTVRONT @07:36 (Keeper, Skylum, Brytesoft, NordVPN(+APAC), PureVPN, ESET, Webroot Inc, IONOS). Still 4 Partnered (Blockchain Council + Wondershare + Tresorit + HTVRONT) + ~9 Pending. ExitLag DENIED @21:30 Sep 7. SID 4747686.',
    jobs: [
      {
