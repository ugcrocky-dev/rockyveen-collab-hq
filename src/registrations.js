...
export const platforms = [
  ...
  },
  {
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Partner account exists (username rockyveen). 2026-09-06 login failed with shared password — reset email sent + reset flow in progress to rejoin AI/SaaS programs.',
    jobs: [],
  },
  {
    id: 'intellifluence',
