...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06: Fresh Impact password-reset email opened; setting shared password RockyCollabs2026!Veen then joining AI/SaaS programs. Username rockyveen.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      'OTP verified + profile refreshed 2026-09-06 (name/rates/IG Reels/@rockyveen/USA). AI keyword search mostly routes Apply → Backstage.com paywalled listings — 0 native UGCjob submits this pass. Keep hunting non-Backstage briefs.',
    jobs: [],
  },
  {
    id: 'soona',
    ...
    category: 'marketplace',
    notes:
      'Application largely complete: Job Types UGC, basic info, headshot, 3 content samples (JPG accepted). Creator dashboard live (marketplace/6781). BLOCKED on Trial brief — requires .mp4/.mov video (JPG rejected). Pause-offerings modal also blocks Manage profile niches/rates. Need one short UGC video to finish activation.',
    jobs: [],
  },
  {
    id: 'joinbrands',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      'Logged in; profile name set to Rocky Veen. Marketplace campaigns stay Anonymized / Requirement not met without social OAuth — cannot apply under email-only rule.',
    jobs: [],
  },
  {
    id: 'framer-dub',
  ...
  },
  {
    ...
    category: 'freelance',
    notes:
      'Profile live at twine.net/rockyveenugc but 2026-09-06 login returns Twine server error ("something went wrong"). Retry later to finish roles/photo/website + apply.',
    jobs: [],
  },
  {
    id: 'shareasale-awin',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      'Logged in 2026-09-06 with shared creds. Descript still under review. Reclaim.ai application nearly done — stuck on required “Have you used Reclaim.ai before?” dropdown. Network form still needs Country/customer/commission submit to unlock mass marketplace applies.',
    jobs: [
      {
        id: 'ps-descript',
        brand: 'Descript',
      ...
      },
      {
        ...
        rate: 'Affiliate',
        notes: 'Form filled; submit blocked by flaky “used before?” dropdown.',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Unlocks marketplace programs; form validation unfinished.',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      'Account created + name set. Campaigns/profile edits blocked behind mobile app modal.',
    jobs: [],
  },
  {
    id: 'soona-trend',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      'Email confirmed + logged in 2026-09-06. Profile/website set. Campaign apply blocked: phone mandatory for profile save; Influencer campaigns need IG/TikTok OAuth; Consumer campaigns sold out.',
    jobs: [],
  },
  {
    id: 'flexoffers',
    ...
    category: 'affiliate',
    notes:
      'Fresh passcode 488603 requested 2026-09-06; verification + offer joins in progress.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      'Mitgo ID confirmed + login OK. Ad space created 2026-09-06, but program applies blocked until Admitad account approval/moderation finishes.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      'Logged in 2026-09-06; application waitlisted. Profile partially filled (name/bio/site/@rockyveen). Save blocked without street address + phone.',
    jobs: [],
  },
  {
    id: 'partnerize',
  ...
  },
  {
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Email confirmed 2026-09-06; admin login requires email 2FA code before full setup.',
    jobs: [],
  },
]
