...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-10 ~23:08 poll-rakuten-more-saas: still locked — 0 unlock/reset/Verification after:2026/09/07. Brand noise only: Flareau @15:31 + Updates Digest/Parallels/ANTA/CapCut/SHOKZ (NOT unlock). Newest Verification still 165312 @09:26 Sep 6 (expired). Did NOT login.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-10 ~23:08 poll-rakuten-more-saas: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — last @10:00 + @09:15 Sep 9; 0 newer through ~23:08 Sep 10. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-10 ~23:08 poll-rakuten-more-saas: SKIP login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. Digistore newsletters only (Francis CEO @12:01; Nick funnel tip @22:20) — not actionable.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
