...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-18 ~01:15 poll-collab-otp-tight: still locked — 0 unlock/reset/Verification after:2026/09/07. Newest Verification still 165312 @09:26 Sep 6 expired. Newest Impact mail still WHOOP Inc decline @19:09 Sep 17 (NOT unlock); SHEIN Email Verification @22:34 ≠ Impact unlock. Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        ...
        appliedAt: '2026-09-04',
        rate: 'Program',
        notes: '2026-09-18 ~01:15: still awaiting Timmy Highley discount code + free Max plan (affiliates@runwayml.com) — 0 newer Timmy reply after Rocky account-ready @21:14 Sep 17 (verify @21:13). Account created under collabs@rockyveen.com; contract already signed.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-18 ~01:15 poll-collab-otp-tight: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/11. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-18 ~01:15 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — last @10:00 + @09:15 Sep 9; 0 newer through ~01:15 Sep 18. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-18 ~01:15 poll-collab-otp-tight: still approved Tapfiliate $178 @12:53 Sep 7 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW Tapfiliate program approvals after:2026/09/11.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-18 ~01:15 poll-collab-otp-tight: SKIP login — prior ~03:38 no-advance (Username rockyveenaffiliate); do not hammer. Newest Digistore mail: Nick newsletter @22:23 Sep 17 (calendar bottleneck — newsletter only) + tips @13:31. Prior Lenée promo @22:17 Sep 14. Manual resolve before AI/SaaS joins. ~10 products already joined.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-18 ~01:15 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/11. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
