...
export const platforms = [
  ...
  },
  {
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Account rockyveen locked after failed logins 2026-09-06; reset link expired. Wait unlock + fresh reset email, then join AI/SaaS programs.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      'Email verified. Descript still under review. 2026-09-06: Marketplace gated behind PartnerStack Network application — form partially filled (affiliate+influencer, rockyveen.com, LinkedIn https://www.linkedin.com/in/rockyveen, AI/Marketing). Country/customer/commission fields flaky; submit + mass-apply Notion/Linear/Loom/etc. still pending.',
    jobs: [
      {
        id: 'ps-descript',
        brand: 'Descript',
  ...
  },
  {
    ...
    photoUploaded: false,
    category: 'marketplace',
    notes: 'Signup started 2026-09-06; email confirmation in progress then campaign apply.',
    jobs: [],
  },
  {
    id: 'flexoffers',
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Signup started; waiting email passcode verification then offer joins.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Publisher signup submitted via Mitgo ID; awaiting email confirmation.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
    ...
    photoUploaded: false,
    category: 'marketplace',
    notes: 'Signup hit Cloudflare/hCaptcha + rate limit; retry later.',
    jobs: [],
  },
  {
    id: 'cj',
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Publisher signup form in progress (country/recaptcha flaky).',
    jobs: [],
  },
  {
    id: 'statusphere',
    ...
    photoUploaded: false,
    category: 'marketplace',
    notes: 'Creator apply flow started 2026-09-06.',
    jobs: [],
  },
  {
    id: 'partnerize',
    ...
    photoUploaded: false,
    category: 'affiliate',
    notes: 'Pepperjam/Ascend redirected to Partnerize signup; form in progress.',
    jobs: [],
  },
]
