...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~16:37 poll-collab-otp-tight: Gmail still NO fresh unlock (latest Impact Verification 165312 @09:26 expired; Reset Password burst AM). Did NOT login. 0 programs.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~16:40 poll-apply-tasks: Network still Pending (Under Review); profile ~69%. Home: 2 apps on hold. Descript Application received / pending review (up to 30d). Reclaim + ElevenLabs on hold (auto-submit when Network Approved). No new mass applies. Skip phone/tax/card/IG OAuth. Impact/FlexOffers/Digistore/Refersion still gated (see OTP poll ~16:37).',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
        ...
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — reconfirmed 2026-09-06 ~16:40.',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-06 ~16:40 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-06 ~16:40. Do not re-submit.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~16:37 poll-collab-otp-tight: skipped — still needs Mobile Phone on Company Information (do not invent phones). 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~16:37 poll-collab-otp-tight: login OK; Instagram (@rockyveen) + rockyveen.com adspaces still Not reviewed — cannot join catalog. Left pending (no re-submit).',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~16:37 poll-collab-otp-tight: login still LOGCAP/B8SC anti-bot — skipped. Username rockyveenaffiliate. Prior: 10 products joined. Goolux + KNX Wetterstation pending.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~16:37 poll-collab-otp-tight: skipped (hard anti-bot Block as of ~15:26; prior password reject). Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~17:06 poll-statusphere-rakuten: no new AI/SaaS since ~16:46 sweep (0 new; Partnered Blockchain Council + Wondershare; 11 software still Pending incl PureVPN+NordVPN APAC). Impact not hammered; FlexOffers phone-blocked. SID 4747686.',
    jobs: [
      {
