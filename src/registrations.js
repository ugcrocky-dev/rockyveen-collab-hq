...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:41 impact-unlock-retry: still locked — 0 notifications@app.impact.com after:2026/09/07 (also 0 after:2026/09/08 incl spam). Newest Verification 165312 @09:26 Sep 6 (expired). Did NOT login (no hammer). 0 programs. Next unlock poll ~06:41.',
    jobs: [],
  },
  {
    id: 'intellifluence',
    ...
    jobs: [
      {
        ...
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — reconfirmed 2026-09-08 ~03:56 (do not re-submit).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-08 ~03:56 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-08 ~03:56 (profile still 69%). Do not re-submit.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:03 poll-collab-otp-tight: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/07. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:03 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). 0 Admitad mail after:2026/09/07. Adspaces leave pending.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:03 poll-collab-otp-tight: still approved Tapfiliate $178 @12:53 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW program approvals.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:03 poll-collab-otp-tight: SKIPPED login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. 0 Digistore mail after:2026/09/07.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:03 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/07. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-08 ~04:15 poll-statusphere-rakuten: SKIP login — Keycloak Invalid since ~03:38 (do not hammer). Gmail (inbox+spam): no NEW Partnered/Denied since ExitLag DENIED @21:30; still 3 Partnered (Blockchain Council + Wondershare + Tresorit @12:05) + ~10 Pending (Keeper, Skylum, Brytesoft, NordVPN(+APAC), PureVPN, ESET, HTVRONT, Webroot Inc, IONOS). SID 4747686.',
    jobs: [
      {
