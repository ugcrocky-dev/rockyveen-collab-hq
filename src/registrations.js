...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:12 poll-apply-tasks: still locked — 0 unlock/reset/Verification after:2026/09/07 (inbox+spam). Only brand Ad Code @12:11 Minor Hotels (NOT unlock). Newest Verification still 165312 @09:26 Sep 6 (expired). Did NOT login (no hammer). Prior ~16:49/~16:22 also 0 unlock. CreatorReady/Creator.co skipped.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:12 poll-apply-tasks: Network still DECLINED/limited — Gmail only the ~19:00 Sep 8 networkquality mail (0 newer from:partnerstack.com after:2026/09/08). Descript still WON @13:18 (ref https://get.descript.com/o5bc1tsufdv4) — no re-submit. Re-apply Network eligible Sep 22; do NOT reapply / invent links. Impact still no unlock (~16:49 confirm; Ad Code only). FlexOffers phone-gated; Digistore skip; Refersion blocked.',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:12 poll-apply-tasks: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/08. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:12 poll-apply-tasks: SKIPPED login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. Digistore newsletter only @11:51 (Top 4 Affiliate Metrics) — not actionable. 0 login/OTP Digistore mail after:2026/09/08.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~19:12 poll-apply-tasks: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/08. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
