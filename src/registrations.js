...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06: Password reset to RockyCollabs2026!Veen + device OTP 165312 succeeded earlier (partner home briefly reachable). Discover/brand pages 404 — 0 programs joined. Later task adae7373 finished failed: reset link expired/invalid + account locked from too many failed logins. Wait for unlock; do not hammer login. Then join AI/SaaS programs.',
    jobs: [],
  },
  {
    id: 'intellifluence',
