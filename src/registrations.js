...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~13:45 impact-unlock-retry: still locked — 0 unlock/reset/Verification after:2026/09/07 (inbox+spam). Newest Verification still 165312 @09:26 Sep 6 expired. Newest Impact-path still PowerA Harry Potter promo @19:53 Sep 16 (brand promo — NOT unlock). Digistore tips newsletter @13:31 + Quelsoft SENT @12:42 + PLAUD @12:15 ≠ unlock. Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~13:45 impact-unlock-retry: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/11. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~13:45 impact-unlock-retry: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — last @10:00 + @09:15 Sep 9; 0 newer through ~13:45 Sep 17. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~13:45 impact-unlock-retry: still approved Tapfiliate $178 @12:53 Sep 7 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW Tapfiliate program approvals after:2026/09/11.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~13:45 impact-unlock-retry: SKIP login — prior ~03:38 no-advance (Username rockyveenaffiliate); do not hammer. Digistore24 tips newsletter @13:31 Sep 17 (Julianne — newsletter only, NOT login/OTP). Prior Lenée promo @22:17 Sep 14. Manual resolve before AI/SaaS joins. ~10 products already joined.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~13:45 impact-unlock-retry: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/11. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
