...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-16 ~07:26 impact-unlock-retry: still locked — 0 unlock/reset/Verification after:2026/09/07 (Gmail unlock-query false-positives only: Narwal promo / Ad Code). 0 Impact mail after:2026/09/16 yet (no Daily Digest yet). Newest still Hill House Home @19:38 Sep 15 + NH Hotels @18:35 + Munchkin/Govee/Duke Cannon/CorelDRAW (NOT unlock) + Daily Digest @07:06 Sep 15 (NOT unlock) + Updates Digest @14:18 Sep 14 (NOT unlock). Newest Verification still 165312 @09:26 Sep 6 expired. Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
