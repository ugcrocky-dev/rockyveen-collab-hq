...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~02:35 poll-collab-otp-tight: Gmail still NO fresh unlock (Impact check ~02:20 same; Verification 165312 @09:26 + AM resets only). Did NOT login. 0 programs. Fresh unlock required.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~01:38 poll-apply-tasks: Network still Pending; profile 69%. Home banner still: 2 program applications on hold until Network approved (Reclaim.ai + ElevenLabs). Descript Application received/pending review. Detail pages may show Apply/Submit CTA while holds remain — did NOT re-submit/mass-apply. No PartnerStack approval mail in Gmail. Skip phone/tax/card/IG. FlexOffers phone-gated; Digistore skip (~00:31 silent fail); Refersion blocked; Impact no fresh unlock (~01:34).',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
        ...
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — home banner reconfirmed 2026-09-07 ~01:38 (do not re-submit).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-07 ~01:38 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-07 ~01:38 (profile 69%). Do not re-submit.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~02:35 poll-collab-otp-tight: skipped — Company Information still requires Mobile Phone (do not invent). No new FlexOffers mail. 0 offers. User must enter phone + Continue.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~02:35 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Adspaces still Not reviewed. Leave pending until Active/manual password clear.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~02:35 poll-collab-otp-tight: skipped login — prior ~00:31 one attempt no advance (no hammer). Username rockyveenaffiliate. 10 products joined. Manual resolve before AI/SaaS joins.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~02:35 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; no new OTPs. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~02:35 poll-collab-otp-tight: no re-login (Keycloak fail ~02:00; last good ~01:14: 2 Partnered + 12 Pending incl Keeper; 0 new). SID 4747686. Skip phone/tax/card/IG.',
    jobs: [
      {
