...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~00:27 poll-collab-otp-tight: still locked — 0 unlock/reset/Verification after:2026/09/07. Newest Verification still 165312 @09:26 Sep 6 expired. Newest Sep 16: collabs SENT PowerA interest reply @21:17 (outbound ≠ unlock) + Fullbeauty declined Woman Within @20:09 + PowerA promo @19:53 + Rothy's/travel/Narwal/Edible/Digest (brand noise — NOT unlock). 0 newer overnight through ~00:27 Sep 17. Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~00:27 poll-collab-otp-tight: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/08. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~00:27 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — last @10:00 + @09:15 Sep 9; 0 newer through ~00:27 Sep 17. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~00:27 poll-collab-otp-tight: still approved Tapfiliate $178 @12:53 Sep 7 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW Tapfiliate program approvals after:2026/09/08.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~00:27 poll-collab-otp-tight: SKIP login — prior ~03:38 no-advance (Username rockyveenaffiliate); do not hammer. Newest Digistore mail still Lenée promo @22:17 Sep 14 (newsletter only). Manual resolve before AI/SaaS joins. ~10 products already joined.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~00:27 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/08. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-17 ~00:27 poll-collab-otp-tight: SKIP login — Keycloak Invalid since ~03:38 (do not hammer). Gmail: no NEW Partnered/Denied after Keeper Security @09:25 Sep 10 / Skylum DENIED @07:51 Sep 14. Still 5 Partnered (Blockchain Council + Wondershare + Tresorit + HTVRONT + Keeper Security) + ~7 Pending (Brytesoft, NordVPN(+APAC), PureVPN, ESET Software, Webroot Inc, IONOS). ExitLag DENIED @21:30 Sep 7. SID 4747686. Impact still no unlock overnight through ~00:27 Sep 17.',
    jobs: [
      {
