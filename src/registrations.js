...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~07:43 poll-collab-otp-tight: still locked — 0 Impact mail in last 12h (newest still Verification 165312 @09:26 Sep 6 + AM resets). Did NOT login. 0 programs. Fresh unlock required — no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~08:00 poll-apply-tasks: Network still Pending; Home banner: \"Your 2 program applications are on hold. If approved to the Network, PartnerStack will automatically submit these applications for you\" (Reclaim.ai + ElevenLabs). Descript Application pending. Reclaim + ElevenLabs on hold pending Network. Profile still 69%. Did NOT re-submit/mass-apply. No PartnerStack approval mail (0 in last 12h). Skip phone/tax/card/IG. FlexOffers phone-gated; Digistore skip; Refersion blocked; Impact no unlock (0 mail last 12h).',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
        ...
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — reconfirmed 2026-09-07 ~08:00 (do not re-submit).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-07 ~08:00 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-07 ~08:00 (profile still 69%). Do not re-submit.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~07:43 poll-collab-otp-tight: skipped — Company Information still requires Mobile Phone (do not invent). 0 FlexOffers mail in last 12h (old Sep 6 verify only). 0 offers. User must enter phone + Continue.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~07:43 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). 0 Admitad mail in last 12h. Adspaces still Not reviewed. Leave pending until Active/manual password clear.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'marketplace',
    notes:
      '2026-09-07 ~06:00 poll-statusphere-rakuten: Gmail (inbox+spam) — no NEW verify/unlock. Still only waitlist mail @12:00 UTC 2026-09-06 + older verify @08:40. Remain registered_waitlisted; no profile unlock. No phone/street invention. No IG OAuth.',
    jobs: [],
  },
  {
    id: 'partnerize',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~07:43 poll-collab-otp-tight: SKIPPED login — prior ~03:38 one attempt no advance (and ~00:31). No hammer. Username rockyveenaffiliate. ~10 products already joined. Manual resolve before AI/SaaS joins. 0 Digistore mail in last 12h.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~07:43 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail in last 12h (old Sep 6 temp codes only). Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~07:43 poll-collab-otp-tight: SKIPPED login — prior ~03:38 Keycloak Invalid email/password (do not hammer). 0 Partnered/unlock mail in last 12h. Still 2 Partnered + 12 Pending incl Keeper (last catalog ~01:14). SID 4747686. Skip phone/tax/card/IG.',
    jobs: [
      {
