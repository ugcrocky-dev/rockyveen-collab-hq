...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~06:19 poll-apply-tasks: Network still DECLINED/limited — Gmail only the ~19:00 networkquality mail (0 newer from:partnerstack.com after:2026/09/08). Prior browser ~22:02: Declined (broken link); re-apply eligible Sep 22; hold banner 2 apps; Descript pending; profile 69% — no re-login this poll (no status-change mail; do not click Apply again; do not invent links). Impact still locked (~06:19 confirm); FlexOffers phone-gated; Digistore skip; Refersion blocked.',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application pending Descript review — reconfirmed via Gmail quiescence 2026-09-09 ~06:19 (last browser ~22:02; existing partnership path).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'DECLINED/limited 2026-09-08 ~19:00 — reason: One of your links is not working. Gmail ~06:19 Sep 9: no newer PartnerStack mail; last browser ~22:02 still Declined / reapply Sep 22. Did not reapply this poll.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~06:19 poll-apply-tasks: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/08. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~06:19 poll-apply-tasks: SKIPPED login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. 0 Digistore mail after:2026/09/08.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~06:19 poll-apply-tasks: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/08. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
