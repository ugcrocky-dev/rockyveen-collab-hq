...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-10 ~10:13 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — @10:00 + @09:15 Sep 9 (+ Sep 8 nags); 0 newer after @10:00. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-10 ~10:13 poll-collab-otp-tight: SKIPPED login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. Digistore newsletters only (@22:18 UI refresh + @11:51 Top 4 Metrics) — not actionable. 0 login/OTP Digistore mail after:2026/09/08.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-10 ~10:13 poll-collab-otp-tight: SKIP login — Keycloak Invalid since ~03:38 (do not hammer). NEW Partnered: Keeper Security @09:25 Sep 10 via Gmail. Now 5 Partnered (Blockchain Council + Wondershare + Tresorit + HTVRONT + Keeper Security) + ~8 Pending (Skylum, Brytesoft, NordVPN(+APAC), PureVPN, ESET, Webroot Inc, IONOS — no ExitLag/HTVRONT/Keeper). ExitLag DENIED @21:30 Sep 7. SID 4747686. Impact still no unlock; Admitad still Mitgo nags only (@10:00/@09:15 Sep 9); Digistore skip.',
    jobs: [
      {
