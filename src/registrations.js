...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~00:34 poll-apply-tasks: Network still Pending; profile 69%. Home banner: 2 program applications on hold (Reclaim.ai + ElevenLabs) until Network approved. Descript Application pending review. Do not re-mass-apply until Network Approved. No PartnerStack approval mail in Gmail. Skip phone/tax/card/IG OAuth. FlexOffers phone-gated; Digistore24 skip (silent fail ~00:31); Refersion blocked skip; Impact no fresh unlock (~00:31).',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
        ...
        rate: 'Affiliate',
        notes: 'Program application on hold pending Network approval — reconfirmed 2026-09-07 ~00:34.',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-07 ~00:34 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-07 ~00:34 (profile 69%). Do not re-submit.',
