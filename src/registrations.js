...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-14 ~02:59 poll-collab-otp-tight: still locked — 0 unlock/reset/Verification after:2026/09/07 (from:notifications@app.impact.com 0 hits; newest Verification still 165312 @09:26 Sep 6 expired). Brand noise / SHEIN false-positive only — NOT unlock. Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-14 ~02:59 poll-collab-otp-tight: Network still DECLINED/limited — 0 newer PartnerStack mail after:2026/09/09 (from:partnerstack.com). Descript still WON @13:18 (ref https://get.descript.com/o5bc1tsufdv4); portal onboarding mail @14:30 Sep 11 — not a Network change; no re-submit. Re-apply Network eligible Sep 22; do NOT reapply / invent links.',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-14 ~02:59 poll-collab-otp-tight: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/08. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-14 ~02:59 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — last @10:00 + @09:15 Sep 9; 0 newer through ~02:59 Sep 14. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-14 ~02:59 poll-collab-otp-tight: still approved Tapfiliate $178 @12:53 Sep 7 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW Tapfiliate program approvals after:2026/09/08.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-14 ~02:59 poll-collab-otp-tight: SKIP login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. Digistore newsletters only (Julianne How-Tos video series @12:34 Sep 13) — not actionable; 0 newer after that.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-14 ~02:59 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/08. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
