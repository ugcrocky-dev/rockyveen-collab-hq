...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~22:18 impact-unlock-retry: Gmail (inbox+spam) still NO fresh unlock/reset. Latest still Verification 165312 @09:26 (expired) + Reset Password burst AM; no unlock mail since. Did NOT login (avoid hammer). Prior ~21:25 / ~21:15 same. 0 programs. Fresh unlock email required. Skipped CreatorReady (phone risk).',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~21:25 poll-apply-tasks: Network still Pending; profile ~69%. Home: 2 program applications on hold. Descript Application pending review (up to 30d). Reclaim.ai + ElevenLabs remain on hold pending Network (do not re-mass-apply). No PartnerStack approval mail in Gmail. Skip phone/tax/card/IG OAuth. FlexOffers phone-gated; Digistore24/Refersion skip; Impact no fresh unlock.',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
        ...
        rate: 'Affiliate',
        notes: 'On hold pending Network approval — reconfirmed 2026-09-06 ~21:25.',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application received / pending Descript review — reconfirmed 2026-09-06 ~21:25 (up to 30d).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'Still Under Review / Pending 2026-09-06 ~21:25. Do not re-submit.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-06 ~21:30 poll-statusphere-rakuten: login OK; 0 new AI/SaaS applies (catalog thin — AI/SaaS/software/cloud). Educative still terms-unavailable; Webroot International not joined (prior terms-blocked). Partnered Blockchain Council + Wondershare; 11 Pending (Skylum, Brytesoft, NordVPN(+APAC), PureVPN, ESET, HTVRONT, Webroot Inc, IONOS, ExitLag, Tresorit). SID 4747686. Skipped phone/tax/card/IG. Impact not hammered; FlexOffers phone-blocked.',
    jobs: [
      {
