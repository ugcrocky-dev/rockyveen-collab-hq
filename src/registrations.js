...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-15 ~23:23 impact-unlock-retry: still locked — 0 unlock/reset/Verification after:2026/09/07 (Gmail unlock-query returned 0 real unlocks; Narwal/Ad Code false-positives only). Newest Impact mail still Hill House Home @19:38 Sep 15 + NH Hotels @18:35 + Munchkin/Govee/Duke Cannon/CorelDRAW (NOT unlock) + Daily Digest @07:06 (NOT unlock) + Updates Digest @14:18 Sep 14 (NOT unlock). Newest Verification still 165312 @09:26 Sep 6 expired. Did NOT login; no hammer.',
    jobs: [],
  },
  {
    id: 'intellifluence',
