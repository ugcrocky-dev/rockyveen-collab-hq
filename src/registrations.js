...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:09 impact-unlock-retry: still locked — 0 unlock/reset/Verification from notifications@app.impact.com after:2026/09/07 and after:2026/09/08 (inbox+spam). Newest still Verification 165312 @09:26 Sep 6 (expired; Account ID 6854059) + AM Sep 6 Reset Impact Password only. Did NOT login (no hammer). Prior ~00:08/~23:08 also 0 unlock. 0 programs. CreatorReady/Creator.co skipped.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:10 poll-apply-tasks: Network still DECLINED/limited — Gmail only the ~19:00 networkquality mail (0 newer from:partnerstack.com after:2026/09/08). Prior browser ~22:02: Declined (broken link); re-apply eligible Sep 22; hold banner 2 apps; Descript pending; profile 69% — no re-login this poll (no status-change mail; do not click Apply again; do not invent links). Impact still locked (~01:09 unlock poll); FlexOffers phone-gated; Digistore skip; Refersion blocked.',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
      ...
      },
      {
        ...
        appliedAt: '2026-09-05',
        rate: 'Affiliate',
        notes: 'Application pending Descript review — reconfirmed via Gmail quiescence 2026-09-09 ~01:10 (last browser ~22:02; existing partnership path).',
      ...
      },
      {
        ...
        appliedAt: '2026-09-06',
        rate: '—',
        notes: 'DECLINED/limited 2026-09-08 ~19:00 — reason: One of your links is not working. Gmail ~01:10 Sep 9: no newer PartnerStack mail; last browser ~22:02 still Declined / reapply Sep 22. Did not reapply this poll.',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:12 poll-collab-otp-tight: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/08. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:12 poll-collab-otp-tight: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen (@09:00 + @07:30 Sep 8) — leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:12 poll-collab-otp-tight: still approved Tapfiliate $178 @12:53 (ref https://tapfiliate.com?ref=ndm2ndd1); no NEW program approvals after:2026/09/08.',
    jobs: [
      {
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:12 poll-collab-otp-tight: SKIPPED login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. 0 Digistore mail after:2026/09/08.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:12 poll-collab-otp-tight: skipped — prior Blocked/anti-bot; 0 Refersion mail after:2026/09/08. Do not hammer. 0 brand programs.',
    jobs: [],
  },
  {
    id: 'rakuten',
    ...
    category: 'affiliate',
    notes:
      '2026-09-09 ~01:32 poll-rakuten-more-saas: SKIP login — Keycloak Invalid since ~03:38 (do not hammer). Gmail only: newest still ExitLag DENIED @21:30 Sep 7 + Tresorit Partnered @12:05; 0 NEW Partnered among pending software (Keeper, Skylum, Brytesoft, NordVPN(+APAC), PureVPN, ESET, HTVRONT, Webroot Inc, IONOS) after:2026/09/08. Still 3 Partnered (Blockchain Council + Wondershare + Tresorit) + ~10 Pending. SID 4747686. FlexOffers phone-blocked; Impact no unlock; Admitad wait adspace; Digistore skip login.',
    jobs: [
      {
