...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-11 ~19:12 poll-rakuten-more-saas: still locked — 0 unlock/reset/Verification after:2026/09/07. Brand noise only (not unlock). Newest Verification still 165312 @09:26 Sep 6 (expired). Did NOT login.',
    jobs: [],
  },
  {
    id: 'intellifluence',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-11 ~19:12 poll-rakuten-more-saas: skipped — still needs Mobile Phone (do not invent). 0 FlexOffers mail after:2026/09/09. 0 offers.',
    jobs: [],
  },
  {
    id: 'admitad',
    ...
    category: 'affiliate',
    notes:
      '2026-09-11 ~19:12 poll-rakuten-more-saas: skipped password — prior Invalid ~23:28 (no hammer). Mitgo still nagging verify ad space Rocky Veen — last @10:00 + @09:15 Sep 9; 0 newer through ~19:12 Sep 11. Leave pending; do not request AI/SaaS until Active.',
    jobs: [],
  },
  {
    id: 'shopify-collabs',
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-11 ~19:12 poll-rakuten-more-saas: SKIP login — prior ~03:38 no-advance (no hammer). Username rockyveenaffiliate. ~10 products joined. Digistore newsletters only (Francis Launch Pad @12:20 Sep 11; Nick funnel tip @22:20 Sep 10) — not actionable.',
    jobs: [
      {
        id: 'ds-funnelcockpit',
        brand: 'FunnelCockpit',
