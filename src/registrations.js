...
export const platforms = [
  ...
  },
  {
    ...
    category: 'affiliate',
    notes:
      '2026-09-07 ~14:32 poll-apply-tasks: Browser dash confirmed — Network still Pending; home banner still \"Your 2 program applications are on hold\" (Reclaim.ai + ElevenLabs); Descript Application pending; profile still 69%. Did NOT re-submit. Gmail: 0 PartnerStack/Descript/Reclaim/ElevenLabs mail after:2026/09/06. Skip phone/tax/card/IG. FlexOffers phone-gated; Digistore skip; Refersion blocked; Impact no unlock (0 mail after:2026/09/07).',
    jobs: [
      {
        id: 'ps-elevenlabs',
        brand: 'ElevenLabs',
